...
1. **Clone Repositori**
   ```bash
   git clone https://github.com/muhhanif27/COMPUTER_REASONING_CBR.git
...
1. **Jalankan 01_scraper.ipynb**
   - Buka notebook di Jupyter:
     ...
     ```
   - Jalankan semua sel untuk mengunduh hingga 60 dokumen PDF kepailitan dari situs Mahkamah Agung dan menyimpan teksnya di folder `data/raw/`.
...
- GitHub Issues: [https://github.com/muhhanif27/COMPUTER_REASONING_CBR/issues](https://github.com/muhhanif27/COMPUTER_REASONING_CBR/)

---

**Catatan**: Perubahan utama adalah penambahan perintah `cd CBR` setelah `cd COMPUTER_REASONING_CBR` untuk mencerminkan struktur direktori yang benar. Pastikan direktori `CBR` sudah ada di repositori Anda, dan sesuaikan informasi kontak (misalnya, email) sesuai kebutuhan. Jika ada penyesuaian lain yang diperlukan, silakan beri tahu!
